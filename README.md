...
Default credentials are configured via `ADMIN_DEFAULT_PASSWORD` environment variable.
If not set, a random password is generated on first run (check server logs).
